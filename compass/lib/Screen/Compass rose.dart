...
class CompassRoss extends StatefulWidget {
  const CompassRoss({Key? key}) : super(key: key);

  @override
  _CompassRossState createState() => _CompassRossState();
}

class _CompassRossState extends State<CompassRoss> {
  double? _bearing;
