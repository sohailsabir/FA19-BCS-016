        ...
        build: (pw.Context context) => <pw.Widget>[
          pw.Table.fromTextArray(
              ...
              data: <List<String>>[
                ...
                <String>['Name', 'Class','Fees','Password' ],
                for (int i = 0; i <data.length; i++)
                  <String>['${i+1}) ${data.elementAt(i)['name']}','${data.elementAt(i)['class']}','${data.elementAt(i)['fees']}','${data.elementAt(i)['password']}'],
              ]),
          pw.Paragraph(text: ""),
